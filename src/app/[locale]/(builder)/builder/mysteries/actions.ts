...
export async function createMysteryAction(formData: FormData) {
  ...
  const isDOA = titleLower.includes('dead on arrival') || titleLower.includes('doa') || themeLower.includes('reality tv') || themeLower.includes('reality show');
  ...
  if (true) {  // scope block
    if (isDOA) {
      console.log('Seeding DOA Reality TV mystery for ID:', mystery.id);
      ...
      const skye = await insertCharacter(supabase, {
        ...
        profile_data: {
          color: "Pink",
          bio: "Skye won Dead On Arrival Season 3. Crowned queen of chaos, she had the most followers, the most airtime, and the most drama. She played the game flawlessly — sweet when the cameras rolled, ruthless when they didn't. Ask anyone in this room and you'll get a different version of Skye. Skye walks into the reunion like she's still the main character. She always knew how to keep her enemies close. That's why half the room still calls themselves her friend.",
      ...
      const nova = await insertCharacter(supabase, {
        ...
        profile_data: {
          ...
          bio: "Nova was never supposed to be on Dead On Arrival — but she showed up to every red carpet and finale taping like she was born for it. Half the fandom didn't realise she wasn't a cast member. She's younger, louder, and tired of living in Skye's shadow. She says she's just here to support her sister. But that dress, that flirty laugh, and that weird tension with Zane? Feels more like she's here to make a name for herself.",
          ...
          act_summary: "Nova is always performing — for the cameras, for the group, for herself. She's charming until she's not.",
      ...
      const blaze = await insertCharacter(supabase, {
        ...
        profile_data: {
          color: "Green",
          bio: "Blaze was Dead On Arrival's poster person — gorgeous, magnetic, and completely toxic. They and Skye were the golden couple… until Betrayal Week, when Blaze kissed another cast member 'for the challenge' and tried to gaslight their way out of it. Now they're back claiming to be chill. They're jittery, distracted, constantly checking their phone. Peace doesn't usually come in crushed-up capsules.",
          presentation_female: {
            bio: "She and Skye were the golden couple of Season 3 until Betrayal Week. She's back, claiming inner peace — but her hands won't stop shaking.",
            ...
            act_summary: "Speak in therapy buzzwords. Act like everything's chill… until someone mentions Skye.",
          ...
          presentation_male: {
            bio: "He and Skye were the golden couple of Season 3 until Betrayal Week. He's back, claiming inner peace — but his hands won't stop shaking.",
            outfit_advice: "Something clean and curated — white or beige button-up, relaxed pants, silver or leather chain — like you're trying to look peaceful but still hot.",
            act_summary: "Speak in therapy buzzwords. Act like everything's chill… until someone mentions Skye.",
            act_bullets: ["Pretend to be zen even when you're clearly not", "Use phrases like 'I'm holding space'", "Get passive-aggressive if people don't agree with you"]
          },
      ...
      const cole = await insertCharacter(supabase, {
        ...
        profile_data: {
          ...
          presentation_male: {
            bio: "He was the host of Dead On Arrival — smooth, flirty, camera-ready. Supposed to stay neutral. Didn't.",
      ...
      const rex = await insertCharacter(supabase, {
        ...
        profile_data: {
          color: "Orange",
          bio: "Rex wasn't part of the original cast — they were a fan-voted wildcard for the reunion special. Their TikTok edits, Reddit theories, and obsessive posts made them a cult favourite. Charming in a 'knows too much' kind of way. Obsessed with the show, and maybe a little more obsessed with Skye. They say they're just here to experience it all… but they've been watching for years. Every move. Every scandal. Every deleted scene.",
          presentation_female: {
            bio: "She campaigned to join the reunion like her life depended on it. Because, in a way, it did. She's obsessed with Skye — and convinced this is her big moment.",
            ...
            act_bullets: ["Overshare show trivia like it's normal conversation", "Stare a little too long; smile a little too wide", "Mention Skye in casual conversation… constantly"]
          },
          presentation_male: {
            bio: "He campaigned to join the reunion like his life depended on it. Because, in a way, it did. He's obsessed with Skye — and convinced this is his big moment.",
      ...
      const jordan = await insertCharacter(supabase, {
        ...
        profile_data: {
          color: "Blue",
          bio: "Jordan wasn't just a contestant — they were a twist. A 'regular person' fan-favourite who came in mid-season and shook things up. But what the cast didn't know? Jordan was planted by production to stir drama. Every whisper, every fight, every 'accidental' reveal — Jordan was the match. Off contract now, but still taking notes. Still pushing buttons. Why does Jordan still know everything that happens off-camera?",
          presentation_female: {
            bio: "She was planted by production as a contestant. She knows everything that happens off-camera — and deleted the security footage that would have saved Skye.",
          ...
          presentation_male: {
            bio: "He was planted by production as a contestant. He knows everything that happens off-camera — and deleted the security footage that would have saved Skye.",
            outfit_advice: "Creative but harmless — tucked tee, rolled-sleeve blazer, chinos, and a too-cool notebook. The vibe is 'I'm just here to observe'... but you're controlling the narrative.",
            act_summary: "Act like a casual friend while calculating everything. Never raise your voice, never show your cards.",
            act_bullets: ["Smile like you're in on something", "Drop passive little bombs, then walk away", "If cornered, claim 'that's not really my role anymore'"]
          },
      ...
      const brooke = await insertCharacter(supabase, {
        ...
        profile_data: {
          color: "Yellow",
          bio: "Brooke made it to the final two — and then watched Skye get the crown and the guy. It was close. Too close. For weeks the hashtags trended her way: #JusticeForBrooke, #WrongGirlWon. She and Skye were tight. Until they weren't. Brooke swears nothing happened, that Skye just stopped texting. Still, she showed up to this reunion polished, prepared, and one glass of wine away from a breakdown.",
          ...
          act_bullets: ["Overcompensate with confidence and sass", "Throw 'no shade' shade constantly", "Pretend not to care — while watching everything Skye does", "Look for opportunities to steal back the spotlight"],
      ...
      const zane = await insertCharacter(supabase, {
        ...
        profile_data: {
          color: "Black",
          bio: "Zane came into Dead On Arrival bold, loud, and instantly iconic. They flirted with everyone, stirred the pot on purpose, and gave the kind of messy interviews that live forever online. They didn't win — but they won the internet. At least until the final cut. Most of Zane's scenes were edited out of the reunion special. Now Zane's holding onto that rage — cryptic posts, bitter captions. Tonight: fresh spray tan, vengeance arc, nothing left to lose.",
          presentation_female: {
      ...
      const mara = await insertCharacter(supabase, {
        ...
        profile_data: {
          color: "Purple",
          bio: "Mara was the glam guru behind the scenes — head of hair and makeup for Dead On Arrival. She and Skye got close during filming, late-night-spill-your-guts close. But after the finale, Skye stopped replying. No call. No thank you. Just silence. Now Mara's been dragged into the reunion, touch-up kit in tow. She says she's just here to powder noses and sip champagne… but someone's been feeding behind-the-scenes tea to a certain someone.",
          ...
          act_bullets: ["Make everything sound like a joke… until it's not", "Give compliments that feel like insults", "Watch everything, say nothing (until it matters)", "Be casually petty — especially toward Skye", "If accused of drama: 'I don't start it, I just retouch it'"],
      ...
      const { error: doaMotErr } = await supabase.from('motives').insert([
        { mystery_id: mystery.id, character_id: nova.id, motive_type: 'power', strength: 'moderate', linked_character_id: skye.id, notes: "Tired of being Skye's shadow. Wants the spotlight — but murder wasn't on her mood board." },
        { mystery_id: mystery.id, character_id: blaze.id, motive_type: 'love', strength: 'critical', linked_character_id: skye.id, notes: "Prepared the poison for Cole, not Skye — but jealousy and drug use made them a puppet in Rex's hands." },
        { mystery_id: mystery.id, character_id: cole.id, motive_type: 'fear', strength: 'low', linked_character_id: skye.id, notes: "Knew Blaze was unstable; said nothing because it made for good TV." },
        { mystery_id: mystery.id, character_id: rex.id, motive_type: 'love', strength: 'critical', linked_character_id: skye.id, notes: "Rejected by Skye for the last time, Rex switched the glasses — a twisted act of 'being part of her story forever'." },
        ...
        { mystery_id: mystery.id, character_id: brooke.id, motive_type: 'revenge', strength: 'high', linked_character_id: skye.id, notes: "Never forgave Skye for stealing the win and going silent. Had motive, opportunity, and a very convenient alibi." },
        ...
        { mystery_id: mystery.id, character_id: mara.id, motive_type: 'revenge', strength: 'moderate', linked_character_id: skye.id, notes: "Ghosted by Skye post-show after a deep friendship. Sent the warning — but too late." }
      ]);
      ...
      const doaRawRels = [
        ...
        { char1: skye, char2: blaze, dynamics: ['romantic', 'rivals'], notes: "The ex. They were the golden couple until Blaze kissed someone else 'for the challenge'." },
      ...
      const doaB1 = await doaInsertBeat({ mystery_id: mystery.id, beat_number: 1, sort_order: 1, event_title: "The Reunion Kicks Off", description: "The cast arrives at the penthouse. Skye walks in last, commanding the room. Old tensions surface immediately — Brooke's smile doesn't reach her eyes, Blaze won't stop staring, and Rex already knows everyone's drink order by heart. Someone already knows they're here for more than just a catch-up.", characters_involved: ["Skye", "Brooke", "Blaze", "Rex", "Zane"], is_required: true, beat_type: 'discovery', timeline_phase: 'pre_crime' });
      const doaB2 = await doaInsertBeat({ mystery_id: mystery.id, beat_number: 2, sort_order: 2, event_title: "Blaze Discovers The Betrayal", description: "Blaze discovers Skye has been secretly hooking up with Cole since the show ended. A string of leaked texts and group chat drama makes it impossible to ignore. Consumed by jealousy and fuelled by whatever's in their pocket, Blaze begins to spiral and starts Googling things they shouldn't.", characters_involved: ["Blaze", "Skye", "Cole", "Jordan"], is_required: true, beat_type: 'discovery', timeline_phase: 'pre_crime' });
      const doaB3 = await doaInsertBeat({ mystery_id: mystery.id, beat_number: 3, sort_order: 3, event_title: "Rex Knows Blaze's Plan", description: "Rex has been 'documenting' everyone in the building. Through overheard conversations and obsessive note-taking, Rex pieces together that Blaze is planning to poison Cole's drink. Rex confesses their love to Skye one final time. Skye laughs it off. Rex goes very quiet.", characters_involved: ["Rex", "Blaze", "Skye"], is_required: true, beat_type: 'twist', timeline_phase: 'crime' });
      const doaB4 = await doaInsertBeat({ mystery_id: mystery.id, beat_number: 4, sort_order: 4, event_title: "Blaze Poisons The Drink", description: "High and heartbroken, Blaze slips sedatives mixed with a lethal dose into a glass intended for Cole during the pre-toast drinks set-up. Mara notices Blaze acting strangely near the bar and alerts Jordan. Jordan files it away as useful content rather than a crisis.", characters_involved: ["Blaze", "Cole", "Mara", "Jordan"], is_required: true, beat_type: 'clue_reveal', timeline_phase: 'crime' });
      const doaB5 = await doaInsertBeat({ mystery_id: mystery.id, beat_number: 5, sort_order: 5, event_title: "Rex Switches The Glasses", description: "Just before the champagne toast, Rex switches Skye's glass with Cole's poisoned one — a final, twisted act of devotion. 'If I can't have her story, I'll be the ending.' Nobody sees it happen. The cameras are pointed the wrong way.", characters_involved: ["Rex", "Skye", "Cole"], is_required: true, beat_type: 'twist', timeline_phase: 'crime' });
      const doaB6 = await doaInsertBeat({ mystery_id: mystery.id, beat_number: 6, sort_order: 6, event_title: "Skye Collapses", description: "Mid-toast, Skye drinks the champagne. Within minutes she's pale, then unconscious, then still. The room descends into chaos. Blaze stands frozen — they know what's in that glass. But they also know who was supposed to drink it.", characters_involved: ["Skye", "Blaze", "Rex", "Mara", "Cole"], is_required: true, beat_type: 'discovery', timeline_phase: 'crime' });
      const doaB7 = await doaInsertBeat({ mystery_id: mystery.id, beat_number: 7, sort_order: 7, event_title: "The Cover-Up Unravels", description: "Jordan, always filming, caught fragments of everything. Mara's notes from glam. Rex's too-calm demeanor. Blaze's Google history. The pieces start fitting together in ways nobody wants them to. A deleted security camera file is recovered. Its timestamp is damning.", characters_involved: ["Jordan", "Mara", "Rex", "Blaze"], is_required: true, beat_type: 'clue_reveal', timeline_phase: 'investigation' });
      const doaB8 = await doaInsertBeat({ mystery_id: mystery.id, beat_number: 8, sort_order: 8, event_title: "The Confession", description: "Rex, believing they've become part of Skye's legacy forever, leaves a voice note: 'Some people live for the camera. Some people die for it. Either way… I'm part of the story now.' It's the most chilling thing anyone in the room has ever heard.", characters_involved: ["Rex"], is_required: true, beat_type: 'twist', timeline_phase: 'resolution' });

      // ── CLUES ───────────────────────────────────────────────────────────────
      const { error: doaClueErr } = await supabase.from('clues').insert([
        // Round 1
        { mystery_id: mystery.id, title: "The Threatening Text Chain", clue_type: 'secret', implication_type: 'circumstantial', round_number: 1, is_essential: false, linked_plot_beat_id: doaB1.id, description: "Skye's DMs with an unknown number: 'You don't deserve the win. Everyone sees what you really are. Time someone did something about it.' The sender's contact name in Skye's phone: 'Don't answer.'" },
        { mystery_id: mystery.id, title: "Nova's Group Chat Drop", clue_type: 'secret', implication_type: 'red_herring', round_number: 1, is_essential: false, linked_plot_beat_id: doaB1.id, description: "Nova in the cast group chat: 'Ik im an a**hole but thought you should know what your sister said...' Skye's reply: 'As I said before, IDGAF. Nova needs character building anyway.'" },
        { mystery_id: mystery.id, title: "Blaze's Google Search History", clue_type: 'physical', implication_type: 'direct', round_number: 1, is_essential: true, linked_plot_beat_id: doaB2.id, description: "EyeSpy monitoring software retrieved from Blaze's phone: 'How to poison someone' / 'How to spike a drink without taste' / 'Do sedatives show up in blood test' / 'Alcohol + sleeping pills dangerous?' / 'Skye DOA cute edits'" },
        { mystery_id: mystery.id, title: "The Leaked DM Thread", clue_type: 'secret', implication_type: 'circumstantial', round_number: 1, is_essential: false, linked_plot_beat_id: doaB2.id, description: "Blaze to Skye: 'Cole and I were together at the same time. I'm more devastated than you.' Skye: 'I can assure you, you're not.'" },
        { mystery_id: mystery.id, title: "The Seen-Zoned Warning", clue_type: 'secret', implication_type: 'red_herring', round_number: 1, is_essential: false, linked_plot_beat_id: doaB1.id, description: "A private message to Skye from 'RealFan_Rex': 'The reunion's gonna set someone off.' Skye's response: SEEN. No reply." },
        { mystery_id: mystery.id, title: "Mara's Side Chat", clue_type: 'testimony', implication_type: 'circumstantial', round_number: 1, is_essential: false, linked_plot_beat_id: doaB4.id, description: "Mara DMs Brooke: 'Should I just tell them?' Brooke: 'They're gonna find out at some point. You should be the one. Skye would hate it.'" },
        ...
        { mystery_id: mystery.id, title: "Mara's Glam Mirror Note", clue_type: 'physical', implication_type: 'direct', round_number: 1, is_essential: true, linked_plot_beat_id: doaB4.id, description: "A sticky note found on the glam mirror: 'FYI — there was white powder all over the corner of my makeup mirror. Pretty sure B used it while I stepped out. Handle it if you need to. Just don't put it on me. – M'" },
        // Round 2
        ...
        { mystery_id: mystery.id, title: "Blaze's Rage Texts", clue_type: 'secret', implication_type: 'direct', round_number: 2, is_essential: true, linked_plot_beat_id: doaB2.id, description: "Blaze's messages to an unknown recipient: 'If I have to watch them stand next to Skye again I'll lose it. The cameras are on. But I will. I'm done being quiet.'" },
        { mystery_id: mystery.id, title: "The Inner Circle Group Chat", clue_type: 'secret', implication_type: 'circumstantial', round_number: 2, is_essential: false, linked_plot_beat_id: doaB4.id, description: "Inner circle chat: 'Blaze is in glam pacing like they're about to explode. They deadass asked me if Skye still talks about them. I saw them staring at the champagne bottles. Is Blaze still on their meds...? I'm not tryna get roofied tonight.'" },
        { mystery_id: mystery.id, title: "Rex's Cheat Sheet Warning", clue_type: 'secret', implication_type: 'circumstantial', round_number: 2, is_essential: false, linked_plot_beat_id: doaB3.id, description: "A DM from Rex to Mara: 'The reunion's gonna set someone off. If someone snaps, it won't be a surprise.' Mara: SEEN. No reply." },
        { mystery_id: mystery.id, title: "Skye's Final Message", clue_type: 'secret', implication_type: 'direct', round_number: 2, is_essential: true, linked_plot_beat_id: doaB6.id, description: "Skye to Cole at 5:20PM: 'You okay? I feel like something's off. Let's talk before the toast...' Message: SEEN. No reply." },
        { mystery_id: mystery.id, title: "The Wardrobe Intercept Audio", clue_type: 'testimony', implication_type: 'direct', round_number: 2, is_essential: true, linked_plot_beat_id: doaB2.id, description: "Jordan's phone, 25 seconds. Jordan: 'Mara said they were in wardrobe for 25 minutes. Just them — Cole and Skye.' Blaze: 'You're joking.' Jordan: 'I'm not. Might be good to get that on camera.' Blaze: 'You'll get something.' [Recording cuts]" },
        { mystery_id: mystery.id, title: "Rex's Diary Entry", clue_type: 'secret', implication_type: 'circumstantial', round_number: 2, is_essential: false, linked_plot_beat_id: doaB3.id, description: "Rex's notes app: 'Tonight felt kind of perfect. I actually think I'm happy — like, the real kind. You looked at me like you meant it this time. Maybe this is it? Maybe it's finally happening...'" },
        { mystery_id: mystery.id, title: "The Deleted Security Camera File", clue_type: 'physical', implication_type: 'direct', round_number: 2, is_essential: true, linked_plot_beat_id: doaB7.id, description: "File: SEC CAM_4B [Bar Area]. Time: 5:40–6:05PM. Status: Permanently Deleted. Actioned by: jordan.p@doatv.tv. Reason: 'corrupted audio, unusable'. Jordan's quote: 'It was mostly Mara ranting anyway — no good angles. Not worth a storyline.'" },
        { mystery_id: mystery.id, title: "Nova & Zane's Plan", clue_type: 'secret', implication_type: 'red_herring', round_number: 2, is_essential: false, linked_plot_beat_id: doaB1.id, description: "Nova to Zane: 'I cannot believe she said that. Especially after EVERYTHING I've done. I have an idea — let's give her a taste of her own medicine. We look exactly the same.' Zane: 'God I think I'm in love with you.'" },
        // Round 3
        { mystery_id: mystery.id, title: "The Burning Heart Thread", clue_type: 'secret', implication_type: 'circumstantial', round_number: 3, is_essential: false, linked_plot_beat_id: doaB5.id, description: "A thread between Skye and an unsaved contact. Only heart-on-fire emojis remain. The final message is Skye's, at 5:52PM — eight minutes before the toast. No reply." },
        { mystery_id: mystery.id, title: "Rex's Final Draft", clue_type: 'secret', implication_type: 'direct', round_number: 3, is_essential: true, linked_plot_beat_id: doaB8.id, description: "Found in Rex's phone drafts: '...But when I told you I loved you, you laughed. Like I didn't exist. You made me feel invisible. Well… there's only one way this ends. –R'" },
        { mystery_id: mystery.id, title: "Skye's Cocktail Napkin", clue_type: 'physical', implication_type: 'red_herring', round_number: 3, is_essential: false, linked_plot_beat_id: doaB6.id, description: "A cocktail napkin with Skye's handwriting found near the bar: 'If this goes wrong tonight — it was always going to. -S'. The ink is smudged at the edge." },
        { mystery_id: mystery.id, title: "The Recorded Argument", clue_type: 'testimony', implication_type: 'direct', round_number: 3, is_essential: true, linked_plot_beat_id: doaB6.id, description: "32 seconds of audio recorded unintentionally from Zane's phone: 'You think this is just content?! This is my life.' / 'You said to post it.' / 'They already think you hooked up anyway.' / *Pause* / 'I never want to see you again.' / 'You're so dramatic.' / 'You're both on camera.'" },
        ...
        { mystery_id: mystery.id, title: "Mara's Warning Voice Note", clue_type: 'testimony', implication_type: 'circumstantial', round_number: 3, is_essential: true, linked_plot_beat_id: doaB5.id, description: "Mara's voice note to Jordan (6:01PM — 3 minutes before the toast): 'Something isn't right. Rex was at the bar alone for two minutes when nobody was looking. Just standing there. Switching something. I thought it was their glass. Jordan, call me back.'" },
        { mystery_id: mystery.id, title: "The Glass Switch Photo", clue_type: 'physical', implication_type: 'direct', round_number: 3, is_essential: true, linked_plot_beat_id: doaB5.id, description: "A blurry photo timestamped 6:03PM from a guest's phone. In the background: a figure in orange (Rex's colour code) moving two champagne flutes on the serving tray, swapping their positions." },
        // Round 4
        { mystery_id: mystery.id, title: "Rex's Confessional Voice Note", clue_type: 'testimony', implication_type: 'direct', round_number: 4, is_essential: true, linked_plot_beat_id: doaB8.id, description: "45.21 seconds. Rex's voice, calm and measured: 'I tried to be quiet. I really did. I watched the whole thing happen. And when the moment came… I directed it to go exactly where it needed to. It's wild how things just fall into place. Some people live for the camera. Some people die for it. Either way… I'm part of the story now.'" },
        { mystery_id: mystery.id, title: "The Producer's Smoking Gun Audio", clue_type: 'testimony', implication_type: 'direct', round_number: 4, is_essential: true, linked_plot_beat_id: doaB7.id, description: "38.64 seconds — Recovered security cam audio (5:52PM): Mara: 'I'm serious — Blaze is not okay. They're twitchy, I'm pretty sure they mixed something into the drinks.' Jordan: 'And you're telling me this like it's a problem?' Mara: 'It's a liability. What if they snap?' Jordan: (laughs) 'Then we get the footage. You want safe, go film MasterChef.'" }
      ]);
      ...
      const { data: doaSubplot, error: doaSubErr } = await supabase.from('subplots').insert({
        mystery_id: mystery.id,
        title: "Nova & Zane's Revenge Pact",
        description: "Nova and Zane conspired to publicly humiliate Skye by leaking old footage of her behaving badly — a red herring that makes them look guilty while Rex and Blaze carry out the real crime.",
      ...
      const { error: doaSubBeatErr } = await supabase.from('subplot_beats').insert([
        { subplot_id: doaSubplot.id, beat_number: 1, description: "Nova and Zane discover they look similar enough to be confused for each other on camera. Nova suggests impersonating Skye to cause chaos. Zane agrees — mostly because they're falling for Nova.", linked_plot_beat_id: doaB1.id },
        { subplot_id: doaSubplot.id, beat_number: 2, description: "Zane is caught near Skye's bag. They claim they were grabbing their own phone. Jordan watches. Says nothing. Files it away.", linked_plot_beat_id: doaB7.id }
      ]);
      if (doaSubBeatErr) throw new Error(`DOA subplot beats failed: ${doaSubBeatErr.message}`);

      console.log('✅ Seeded DOA Reality TV mystery successfully! 9 characters, 16 relationships, 8 motives, 8 beats, 27 clues, 1 subplot.');
      ...
      const beat1 = await insertBeat({
        ...
        characters_involved: ["Barnaby Frost", "Mimi Le Grand", "Seraphina Gray", "Madame Zara", "Silas"],
        is_required: true,
        beat_type: 'discovery',
      ...
      const beat2 = await insertBeat({
        ...
        characters_involved: ["Barnaby Frost", "Jax", "Silas", "Seraphina Gray"],
        is_required: true,
        beat_type: 'discovery',
      ...
      const beat3 = await insertBeat({
        ...
        characters_involved: ["Professor Thaddeus", "Lucius Vane", "Madame Zara"],
        is_required: true,
      ...
      const beat4 = await insertBeat({
        ...
        characters_involved: ["Rory Vance", "Zephyr", "Penelope 'Penny' Lane", "Beatrix 'Gigi' Laurent"],
        is_required: true,
        beat_type: 'twist',
