        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 text-[10px] font-black tracking-[0.2em] uppercase text-brand-pink bg-brand-pink/5 rounded-full border border-brand-pink/10">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href={`/${locale}/themes`} className="px-10 py-5 bg-brand-pink text-white rounded-full font-black uppercase tracking-widest text-sm hover:bg-brand-dark transition-all shadow-xl hover:translate-y-[-4px] active:scale-95 text-center">
                  {dict.home.hero.ctaPick}
                </Link>
                <Link href={`/${locale}/how-it-works`} className="px-10 py-5 bg-white text-brand-dark border-2 border-gray-100 rounded-full font-black uppercase tracking-widest text-sm hover:border-brand-pink transition-all hover:translate-y-[-4px] active:scale-95 text-center">
            ...
            <div className="relative group">
              <div className="absolute -inset-4 bg-brand-pink/5 rounded-[40px] opacity-10 transition-opacity"></div>
              ...
              {/* Badge */}
              <div className="absolute -top-6 -right-6 w-24 h-24 bg-brand-pink rounded-full flex items-center justify-center text-white font-black uppercase text-[9px] tracking-widest rotate-12 shadow-2xl border-4 border-white pointer-events-none text-center leading-tight p-2">
