...
async function AdminAnalyticsStats() {
...
function AdminAnalyticsSkeleton() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {[1, 2, 3, 4].map((i) => (
        <div key={i} className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm h-28 animate-pulse flex flex-col justify-center space-y-3">
