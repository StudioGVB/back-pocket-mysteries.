      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.07);max-width:600px;width:100%;">
        ...
        <tr>
          <td style="padding:48px 48px 32px;">
            <h1 style="color:#111;font-size:28px;font-weight:900;margin:0 0 20px;letter-spacing:-0.5px;">Your mystery starts here...</h1>
            <p style="color:#555;font-size:16px;line-height:1.7;margin:0 0 16px;">Since we need to send you details about your mystery, we need you to confirm your email!</p>
            <p style="color:#555;font-size:16px;line-height:1.7;margin:0 0 36px;">It only takes one click, and then the secrets, suspects, and storylines are all yours.</p>

            <!-- CTA Button -->
            <table cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" style="padding:0 0 44px;">
                  <a href="https://mysteries.backpocketgames.com" style="background:#fe04c6;color:#fff;font-size:16px;font-weight:900;text-decoration:none;padding:16px 40px;border-radius:50px;display:inline-block;letter-spacing:0.5px;">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:28px;">
              <tr>
                ...
                <td style="text-align:center;padding:0 12px;white-space:nowrap;">
                  <span style="color:#bbb;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;">What awaits you</span>
                </td>
                <td style="border-top:1px solid #f0f0f0;width:42%;"></td>
              </tr>
            </table>
              ...
              <tr>
                <td style="padding:0 0 16px;">
                  <table cellpadding="0" cellspacing="0"><tr>
                    ...
                    <td>
                      <p style="margin:0 0 2px;color:#222;font-size:14px;font-weight:700;">Fully custom mysteries</p>
                      <p style="margin:0;color:#888;font-size:13px;line-height:1.6;">Built around your guests, themes, and inside jokes.</p>
                    </td>
                  </tr></table>
                </td>
              </tr>
              <tr>
                <td style="padding:0 0 16px;">
                  <table cellpadding="0" cellspacing="0"><tr>
                    ...
                    <td>
                      <p style="margin:0 0 2px;color:#222;font-size:14px;font-weight:700;">Character sheets emailed to guests</p>
                      <p style="margin:0;color:#888;font-size:13px;line-height:1.6;">Everyone gets their secret role, straight to their inbox.</p>
                    </td>
                  </tr></table>
                </td>
              </tr>
              <tr>
                <td>
                  <table cellpadding="0" cellspacing="0"><tr>
                    <td style="font-size:22px;padding-right:14px;vertical-align:top;padding-top:2px;">📦</td>
                    <td>
                      <p style="margin:0 0 2px;color:#222;font-size:14px;font-weight:700;">Everything in one place</p>
                      <p style="margin:0;color:#888;font-size:13px;line-height:1.6;">Scripts, clues, and host guides — all ready to download.</p>
                    </td>
                  </tr></table>
                </td>
              </tr>
            ...
            <p style="color:#aaa;font-size:13px;line-height:1.7;margin:0 0 20px;">If you didn't create an account with Back Pocket Mysteries, you can safely ignore this email.</p>
